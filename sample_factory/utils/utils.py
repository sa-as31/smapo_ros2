...
def scale_to_range(np_array, min_, max_):
    ...
    ret_array = (np_array - min_arr) / (max_arr - min_arr) 

    ret_array = ret_array * (max_ - min_) + min_  
    return ret_array
...
def kill_processes(processes):
    ...
    processes_to_save = ['torch_shm', 'resource_tracker', 'semaphore_tracker', 'wandb']
...
def experiment_dir(cfg):
    ...
    if experiment is None:
        return ensure_dir_exists(experiments_root)
